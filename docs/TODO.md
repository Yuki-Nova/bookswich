...
## �ṹ�ؽ��޸���������������/�ڱ���ʶ��2026-08-09 �ƻ�������׼��

**��������ʵ������������ʵ�⣩**��
- b8������ҽѧ���ۡ�structure.json = **345 ��**����ʵӦΪ ~11 �£���b7������ѧ��= 16 ������
- ��������`RE_CH_LEVEL1`/`RE_LEVEL2_JIE` �� `CH_NUM` ֻ���������� `[һ�����������߰˾�ʮ���㩖]+`��
  `��1��`/`��1��`�����������֣�ȫ��©�� �� `_detect_chapter_style` ͳ�� numbered=0 �� ���С��ޱ�š��� hash ���ף�
  `_extract_toc_titles` Ŀ¼��ȡͬ��ֻ���������� �� toc_titles=�� �� ������ʧЧ��`not toc_titles` ���У���
  **MinerU ���� `#` �У���������/���ݼ��/����2-1/����/����С���⣩ȫ������** �� 345 ����Ƭ
- ��������С���֣�19 ��ģ�������ȫ�����£�����ʵ����ͬ�����������������������°棨�� hash ���ף�
- b8 ���� md �������̣�20 �����������ؽ�**����Ҫ���� MinerU ���**����������ʽ key ��� 870/1000 ����

### P0 �� structure.py �����޸������ޣ�
- `CH_NUM` ��չ��`CN_OR_AR = (?:[һ�����������߰˾�ʮ���㩖]+|\d{1,3})`
- `RE_CH_LEVEL1` / `RE_LEVEL2_JIE` / `RE_LEVEL3` / `RE_TOC_LINE` / `_extract_toc_titles` /
  `check_section_continuity` ͳһ֧�֣����������� + `�� 3 ��` ���ո���壨`��\s*CN_OR_AR\s*��`��
- `cn_to_int` ֧�ְ��������֣���1�� �� 1��
- Ч����`��1�� ����` ������ֱ��ʶ�� �� numbered>0 �� �ص� numbered ��� �� `����2-1`/`����`/`1. ��` ȫ���ع�����

### P1 �� hash ���׷��˻�
- ȥ�� `not toc_titles or ...` ���з�֧��toc ������Ϊ��ʱ hash ���ײ����ã��� 0 �²���Ƭ��
- ��Ϊ�仯����Ŀ¼ҳ���ޱ�ŵĽ̲��ؽ��� 0 �£����˹����ף���b6/b8 ����Ŀ¼�������Ľ̲�ȷ����Ŀ¼ҳ������Ӱ��

### P2 �� С��ʶ����ǿ�����β������۲��޸�Ч�������飩
- `1. ��`�������ֵ㣩��`(1) �Ըɵ�����`�����������ţ���`1��xxx` �� 3/4 ������
- ���գ������б� `1.` �д������ڣ����˸��ʸߣ������������֤

### ��֤�ջ�
1. �������� pytest��`backend/tests/test_structure_arabic.py`����������/���ո���/���������������/toc ������/cn_to_int��
2. ���� pytest ȫ��
3. ��ʵ������֤��SFTP �������� b8 �� 20 �� md �� �������޸��� rebuild �� �����½��� ~11 + ����/���Ⲣ������ + outline ���
   ����ѡȫ��·�����ز��� token ���� PDF 486 ҳ �� 486 ����������δ�Ķ����Ǳ��裬Ĭ�ϲ�����
4. ����������SFTP �ϴ� structure.py �� **��ʱ�ű�Ԥ���ؽ�������������** �� �½���ȷ�� �� ���ݾ� structure.json ��
   systemctl restart bookswich �� ���� b8 �ؽ� + parse_status=structure_ok �� ���� obsidian zip ��֤ 00_���� ~11 ��

### ����
- ����ſ��������ģ����� 1 �ڡ�����������/�б����� �ع����� + outline �˹����
- hash ���׽��ú���Ŀ¼�ޱ�Ž̲� 0 �� �� ��ȷ��Ϊ�仯����Ҫʱ�ֶ�ָ������ؽ�
- �������ؽ����Ǿɲ��� �� �ȱ��ݣ����������ʱ�ж� �� �ɽ���

### ���ߵ�
1. P2 С��ʶ�𱾴��������������鲻����
2. ����ȫ��·�������ղ��� token 486 ҳ���������������鲻�����������������������֤���ɣ�

---

## 表格公式渲染：门禁制转换（2026-08-10 已批准执行完毕 ✅）

**背景**：MinerU 表格内公式用 <eq> 标签，HTML <table> 内定界符 Typora/Obsidian 不渲染；
HTML→MD 全量转换导致列错乱（2026-08-09 尝试多轮后用户拍板回退，教训记录在案）。
...
**实测**：《医药应用概率统计》349 表格 → 176 转 Markdown（列零错乱）+ 173 保留（138 合并 + 33 超宽 + 2 超长）

**验证**：pytest 37/37（新增 test_table_md.py 15 用例 + conftest.py）+ ad-hoc 21/21 + 全量数据自动校验

**git**：7ea5d9b（feat: gated HTML table -> Markdown conversion）
